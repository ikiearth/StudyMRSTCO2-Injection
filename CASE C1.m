...
W = verticalWell(W, G, rock, ...
    1, 1, 5:10, ...             % Lokasi: baris (I=1), kolom (J=1), perforasi penuh (K=[5:10])
    'name', 'Prod_1', ...       % Nama sumur
...
% Sumur Produksi: P2
W = verticalWell(W, G, rock, ...
    30, 1, 5:10, ...            % Lokasi: baris (I=30), kolom (J=1), perforasi penuh (K=[5:10])
    'name', 'Prod_2', ...       % Nama sumur
    'compi', [0 1 0], ...       % Produksi hanya minyak
    'val', 100 * barsa, ...     % Tekanan dasar sumur (BHP)
    'type', 'bhp',...           % Kontrol berdasarkan tekanan dasar
    'sign', -1);                % Production (Sign = -1) or Injection (Sign = 1)
...
% Sumur Produksi: P3
W = verticalWell(W, G, rock, ...
    30, 20, 5:10, ...           % Lokasi: baris (I=30), kolom (J=20), perforasi penuh (K=[5:10])
    'name', 'Prod_3', ...       % Nama sumur
    'compi', [0 1 0], ...       % Produksi hanya minyak
    'val', 100 * barsa, ...     % Tekanan dasar sumur (BHP)
    'type', 'bhp',...           % Kontrol berdasarkan tekanan dasar
    'sign', -1);                % Production (Sign = -1) or Injection (Sign = 1)
...
% Sumur Produksi: P4
W = verticalWell(W, G, rock, ...
    1, 20, 5:10, ...            % Lokasi: baris (I=1), kolom (J=20), perforasi penuh (K=[5:10])
    'name', 'Prod_4', ...       % Nama sumur
    'compi', [0 1 0], ...       % Produksi hanya minyak
    'val', 100 * barsa, ...     % Tekanan dasar sumur (BHP)
    'type', 'bhp',...           % Kontrol berdasarkan tekanan dasar
    'sign', -1);                % Production (Sign = -1) or Injection (Sign = 1)
...
% Sumur Injeksi: I1
W = verticalWell(W, G, rock, ...
    15, 10, 10, ...             % Lokasi: baris (I=15), kolom (J=10), perforasi penuh (K=10)
    'name', 'Inj', ...          % Nama sumur
...
numProdWells = 4; % Jumlah sumur produksi
numInjWells = 1;  % Jumlah sumur injeksi
...
outputFilename = 'WellData-FieldCase2-05.xlsx';
